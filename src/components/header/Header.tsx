...
const Header: React.FC<{ isHavingSearchBox?: boolean }> = ({
  ...
  return (
    <div className="flex justify-center items-center bg-gradient-main bg-gradient-to-r from-cs-primary-100 to-cs-primary-200 ">
      <div className="mobile-645px:h-auto mobile-645px:pt-16px mobile-645px:pb-16px mobile-645px:block 2xl:w-full 2xl:pl-16px 2xl:pr-16px h-118px w-1152px flex justify-between items-center">
        <Link href="/">
          <a data-testid="logo">
            <Logo />
          </a>
        ...
        {isHavingSearchBox && (
          <div
            ...
            data-testid="search"
          >
            <div className="w-384px mobile-500px:w-full">
              <SearchBox />
            </div>
          </div>
        )}
